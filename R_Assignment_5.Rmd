...
Based on the Interaction Plot shown in part-c of this question, it is evident that the highest number of inquiries are observed on Fridays. This finding suggests that the company should consider charging a premium for posting advertisements on Fridays as advertisers tend to post the maximum number of ads on this day. Additionally, the inquiries for the Sports section are comparatively lower than those for the News and Business sections throughout the week. Therefore, the company can lower the prices for the Sports section to attract more advertisers and increase profits.
