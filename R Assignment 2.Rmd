...
b. **Success / Failure Conditions** : In order to use the Normal distribution to check this claim, we need at least 10 expected successes and 10 expected failures.
...
Therefore, **we accept $H_{0}$, Null Hypothesis** because $p$-value is greater than $\alpha$, level of significance.
